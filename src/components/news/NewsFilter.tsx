    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1 md:mx-0 md:px-0 md:flex-wrap md:overflow-visible">
        <button
          ...
          className={`px-4 py-2.5 min-h-11 rounded-xl text-xs font-semibold transition-all duration-200 whitespace-nowrap flex-shrink-0 ${
            !activeCategory
        ...
        {(activeCategory || activeQuery) && (
          <button
            ...
            className="px-4 py-2.5 min-h-11 rounded-xl text-xs font-semibold text-[#e63946] bg-[#e63946]/5 hover:bg-[#e63946]/10 transition-colors duration-200 flex items-center gap-1 whitespace-nowrap flex-shrink-0"
          >
            <X className="w-3 h-3" />
            Pastro
          </button>
