        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-2 sm:py-2.5">
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
              <div className={`w-8 h-8 sm:w-9 sm:h-9 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors duration-300 ${playing ? 'bg-[#e63946]/15' : 'bg-white/5'}`}>
                <Radio className={`w-3.5 h-3.5 sm:w-4 sm:h-4 transition-colors duration-300 ${playing ? 'text-[#e63946]' : 'text-slate-400'}`} />
              </div>
              <div className="min-w-0">
                <p className="text-xs sm:text-sm font-semibold text-white leading-tight truncate">Radio Fontana</p>
