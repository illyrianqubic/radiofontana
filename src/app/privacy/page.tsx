...
export const metadata: Metadata = {
  title: 'Politika e Privatësisë | RTV Fontana',
  description:
    'Politika e privatësisë e RTV Fontana: si mbledhim, përdorim dhe mbrojmë të dhënat personale sipas GDPR. Cookies, analytics dhe të drejtat tuaja.',
...
const sections: LegalSection[] = [
  {
    ...
    paragraphs: [
      'Radio Fontana është media lokale me seli në Istog, Kosovë. Kjo politikë zbatohet për faqen radiofontana.org, aplikacionin tonë Android RTV Fontana (com.radiofontana.app) në Google Play Store dhe shërbimet përkatëse.',
