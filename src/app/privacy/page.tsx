...
const sections: LegalSection[] = [
  {
    ...
    paragraphs: [
      'RTV Fontana është media lokale me seli në Istog, Kosovë. Kjo politikë zbatohet për faqen radiofontana.org, aplikacionin tonë Android RTV Fontana (com.radiofontana.app) në Google Play Store dhe shërbimet përkatëse.',
